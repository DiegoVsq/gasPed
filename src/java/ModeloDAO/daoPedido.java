...
public class daoPedido implements pedCRUD{
    ...
    public List listarPedido() {
        ...
        String sql = "SELECT id_Pedidos, fecha_inicio, fecha_entrega, importe_total, pedido.id_Estado_pedido, pedido.id_Producto, pedido.id_Repartidor, pedido.id_Cliente, "
                + "cliente.nombre as nombreC, producto.nombre_producto as nombrePdto, repartidor.nombre as nombreRep, estado_pedido.nombre_estado as nombreEP from gasv1.pedido INNER JOIN gasv1.estado_pedido ON pedido.id_Estado_pedido = estado_pedido.id_Estado_pedido "
                + "INNER JOIN gasv1.producto ON  pedido.id_Producto = producto.id_Producto INNER JOIN gasv1.repartidor ON pedido.id_Repartidor = repartidor.id_Repartidor INNER JOIN gasv1.cliente ON pedido.id_Cliente = cliente.id_Cliente";
        ...
        try {
            ...
            while (rs.next()) {
                ...
                bEP.setNombre_estado(rs.getString("nombreEP"));
                ...
                bPed.setPrecio(rs.getInt("importe_total"));
    ...
    public beanPedido list(int idPedido) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                bPed1.setPrecio(rs.getInt("importe_total"));
    ...
    public boolean add(beanPedido bPedido) {
        String sql = "INSERT INTO pedido (fecha_inicio, importe_total, id_Estado_Pedido, id_Producto, id_Repartidor, id_Cliente, fecha_entrega, id_Pedidos) VALUES "
    ...
    public boolean edit(beanPedido bPedido) {
        String sql = "UPDATE pedido set fecha_inicio='"+bPedido.getFecha_inicio() +"',"
                + " importe_total= '"+bPedido.getPrecio() +"',"
